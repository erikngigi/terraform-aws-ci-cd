resource "aws_cloudfront_origin_access_control" "hugo_site" {
  name                              = "${var.hugo_bucket_id}-oac"
  description                       = "Hugo website origin access control"
...
resource "aws_cloudfront_distribution" "hugo_site" {
  ...
  origin {
    ...
    origin_id                = "S3-${var.hugo_bucket_id}"
  ...
  default_cache_behavior {
    ...
    target_origin_id = "S3-${var.hugo_bucket_id}"
